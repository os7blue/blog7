  ...
  var gather = {
    ...
    ,layEditor: function(options){
      var html = '<div class="fly-edit">'
        ...
        +'<span type="picture" title="插入图片：img[src]"><i class="layui-icon">&#xe64a;</i>图片</span>'
        ...
        +'<span type="yulan" title="预览"><i class="layui-icon">&#xe629;</i>预览</span>'
      +'</div>';
      var log = {}, mod = {
          ...
          layer.open({
            ...
            ,content: ['<ul class="layui-form layui-form-pane" style="margin: 20px;">'
              ,'<li class="layui-form-item">'
                ...
                ,'</div>'
                ,'<button type="button" class="layui-btn" id="upImg"><i class="layui-icon">&#xe67c;</i>上传图片</button>'
              ,'</li>'
              ,'<li class="layui-form-item" style="text-align: right;">'
                ,'<button type="button" lay-submit lay-filter="uploadImages" class="layui-btn">确认</button>'
                ,'<button type="button" class="layui-btn layui-bg-blue upImgClose">取消</button>'
              ,'</li>'
            ,'</ul>'].join('')
            ,success: function(layero, index){
              ...
              // 简易编辑器内部取消提交上传的图片
              $(document).on('click','.upImgClose',function(){
                layer.close(index);
              });
            }
          });
